module github.com/baishancloud/mallard
...
require (
	...
	github.com/influxdata/influxdb v0.0.0-20180816195907-c314fc494e21
	...
	go.uber.org/atomic v0.0.0-20180806045314-ca680462431f // indirect
